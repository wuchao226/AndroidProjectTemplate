...
import com.wuc.ft_home.databinding.ActivityCrashBinding
import com.wuc.lib_base.ext.appVersionCode
import com.wuc.lib_base.ext.appVersionName
import com.wuc.lib_base.ext.doOnBackPressed
...
/**
  ...
  * @description: 崩溃捕捉界面
  */
class CrashActivity : BaseBindingReflectActivity<ActivityCrashBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        binding.ivCrashInfo.doOnDebouncingClick {
            binding.dlCrashDrawer.openDrawer(GravityCompat.START)
        }
        binding.ivCrashShare.doOnDebouncingClick {
            // 分享文本
        ...
        binding.ivCrashRestart.doOnDebouncingClick {
            // 重启应用
            RestartActivity.restart(this)
            finish()
        }

        doOnBackPressed(this) {
            // 重启应用
            RestartActivity.restart(this)
            finish()
        }
            ...
            if (permissions.contains(Manifest.permission.INTERNET)) {
                ...
                lifecycleScope.launch(Dispatchers.IO) {
                    ...
                    lifecycleScope.launch(Dispatchers.Main) {
                        binding.tvCrashInfo.text = builder
                    }
                }
            } else {
                binding.tvCrashInfo.text = builder
