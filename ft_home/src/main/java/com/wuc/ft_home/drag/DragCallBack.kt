 ...
 * @description:
 */
class DragCallBack(adapter: DragRecyclerViewActivity.DragAdapter, data: MutableList<String>) : ItemTouchHelper.Callback() {
    ...
    override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
        if (direction == ItemTouchHelper.START) {
            WLogUtils.it(TAG, "START--->向左滑")
        } else {
            WLogUtils.it(TAG, "END--->向右滑")
        }
