package com.wuc.lib_base.log

import android.app.Application
import android.os.Environment
import com.google.gson.Gson
import com.wuc.lib_base.log.printer.ConsolePrinter
import com.wuc.lib_base.log.printer.FilePrinter
import com.wuc.lib_base.log.printer.LogPrinter
 ...
 */
class LogManager private constructor(private val config: LogConfig, logPrinters: Array<out LogPrinter>) {
    companion object {
        @Volatile
