package com.wuc.lib_room.database

import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import com.wuc.lib_base.ext.application
import com.wuc.lib_room.dao.VideoListCacheDao
import com.wuc.lib_room.entity.VideoInfo
...
abstract class WDataBase : RoomDatabase() {
    ...
    companion object {
        private var dataBase: WDataBase? = null

        //同步锁，可能在多个线程中同时调用
        @Synchronized
        fun getInstance(): WDataBase {
            return dataBase ?: Room.databaseBuilder(application, WDataBase::class.java, "WTea_DB")
                    //是否允许在主线程查询，默认是false
